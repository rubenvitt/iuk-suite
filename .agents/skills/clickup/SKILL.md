...
| **Release Notes** (`portal/_lib/neuigkeiten`) | die Anwender | Was ist für mich jetzt anders? Meist: **keine Notiz** — die Regeln stehen in `AGENTS.md` |
| **Falle in `AGENTS.md`** | der nächste Agent | Was hat einen halben Tag gekostet, das kein Tor findet? |
