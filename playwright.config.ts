...
export default defineConfig({
   ...
   * 19 Kommentaranker aus zehn Dateien zeigen als `playwright.config.ts:<zeile>`
   * in diese Datei (`:95`, `:108`, `:156`, `:158`, `:182`, `:245-268`, `:326` …).
   ...
   * Mangel und steht als eigenes Ticket auf dem Board.
   *
