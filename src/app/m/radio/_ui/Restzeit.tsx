...
export function Restzeit({
  ...
  useEffect(() => {
     ...
     * aus DERSELBEN Uhr (`AusleihRahmen.tsx`, `jetzt`), `true` heisst dort `laeuftAb <= jetzt`,
     ...
     * Riegel ist `requireAusleihSchreibend` in der Action (`_lib/ausleihZugang.ts`, `requireAusleihSchreibend`),
     * nicht diese Insel.
     */
