...
/**
 * ALIAS-ROUTE FUER DEN ALT-PFAD `/admin/devices` — Betreiberentscheidung vom 2026-08-27
 * (`.superpowers/sdd/adminlink/KONTEXT.md`). Er bedient ZWEI Alt-Pfade: den des Kiosks und — ueber C2 — `radio-admin.iuk-ue.de/devices`.
 *
...
export function GET(req: Request): Response {
  return hostAbweisung(req) ?? aliasAntwort(aliasZiel("/admin/devices"));
}
