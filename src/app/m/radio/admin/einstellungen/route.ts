...
/**
 * ALIAS-ROUTE FUER DEN ALT-PFAD `/admin/einstellungen` — Betreiberentscheidung vom 2026-08-27
 * (`.superpowers/sdd/adminlink/KONTEXT.md`). ⚠️ ER GREIFT ERST MIT C2: `/einstellungen` gab es nur unter `radio-admin.iuk-ue.de`. ⛔ NICHT ZU VERWECHSELN mit `/admin/settings` des Kiosks — das war die Passwortaenderung und bekommt bewusst keinen Alias.
 *
...
export function GET(req: Request): Response {
  return hostAbweisung(req) ?? aliasAntwort(aliasZiel("/admin/einstellungen"));
}
