...
/**
 * ALIAS-ROUTE FUER DEN ALT-PFAD `/admin/update` — Betreiberentscheidung vom 2026-08-27
 * (`.superpowers/sdd/adminlink/KONTEXT.md`). ⚠️ ER GREIFT ERST MIT C2: `/update` gab es nur unter `radio-admin.iuk-ue.de`, und dieser Host loest ohne den Traefik-Redirect gar nicht auf (Bericht §1.6, C2 ist unabgehakt).
 *
...
export function GET(req: Request): Response {
  return hostAbweisung(req) ?? aliasAntwort(aliasZiel("/admin/update"));
}
