...
/**
 * ALIAS-ROUTE FUER DEN ALT-PFAD `/admin/history` — Betreiberentscheidung vom 2026-08-27
 * (`.superpowers/sdd/adminlink/KONTEXT.md`). Der Alt-Kiosk laeuft unter demselben Host wie das Modul (Bericht §1.1) — dieser Alias wirkt ab dem Cutover unmittelbar.
 *
...
export function GET(req: Request): Response {
  return hostAbweisung(req) ?? aliasAntwort(aliasZiel("/admin/history"));
}
