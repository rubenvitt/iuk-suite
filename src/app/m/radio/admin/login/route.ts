...
/**
 * ALIAS-ROUTE FUER DEN ALT-PFAD `/admin/login` — Betreiberentscheidung vom 2026-08-27
 * (`.superpowers/sdd/adminlink/KONTEXT.md`). Er bedient ZWEI Alt-Pfade: den des Kiosks und — ueber den Traefik-Redirect C2 — `radio-admin.iuk-ue.de/login`.
 *
...
export function GET(req: Request): Response {
  return hostAbweisung(req) ?? aliasAntwort(aliasZiel("/admin/login"));
}
