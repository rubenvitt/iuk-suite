...
describe("radio-Ereignisse: die vier Spalten der Insel", () => {
  it("leere Werte werden als Gedankenstrich dargestellt", async () => {
     ...
     * (`_lib/lesepfade/ereignisse.ts`, `wertText`). Das ist die Hausform: `GeraeteTabelle.tsx`, `LEER`
  ...
  it("ohne Ereignisse steht ein Leertext statt einer leeren Tabelle", async () => {
     ...
     * `GeraeteTabelle.tsx` an seiner `Datentabelle` fuehrt, weil dort eine Suche mit Filtern darueber steht und
