 ...
 * (`_lib/lesepfade/geraete.ts:757-763`), nicht in vier Rundlaeufen mit `pageSize: 1` wie im
 ...
 * des Lesepfads: `desc(createdAt)` (`_lib/lesepfade/geraete.ts`, `geraeteListe`, 1:1 zu
