 ...
 * KEIN "use client" (Falle 6, `CLAUDE.md:27`; durchgesetzt von `riegel.test.ts:909-962`).
 *
 ...
 * (Kopie aus `_lib/quelltextScan.ts:61-81`). Ohne diesen Kopf traefe der Scan nichts und
