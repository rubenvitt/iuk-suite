 ...
 *
 * ⛔ ZEICHENGLEICH AUS DEM BESTAND UEBERNOMMEN (`src/app/m/radio/_lib/quelltextScan.ts:61-81`,
...
describe("radio-Gate-Schranke: die vier Eigenschaften aus Spec:3013-3031", () => {
  ...
  it("gateGesperrt macht keinen Datenbankzugriff — Quelltext-Scan", async () => {
     ...
     * Werkzeug, das der Bestand dafuer haelt (`src/app/m/radio/_lib/quelltextScan.ts:61-81`,
     ...
     *      bewusst stehen (`_lib/quelltextScan.ts:55-59`: ein naiver Stripper koennte eine
