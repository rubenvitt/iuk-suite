 ...
 *
 * ⛔ ZEICHENGLEICH AUS DEM BESTAND UEBERNOMMEN (`src/app/m/radio/riegel.test.ts:163-183`,
...
describe("radio-Gate-Schranke: die vier Eigenschaften aus Spec:3013-3031", () => {
  ...
  it("gateGesperrt macht keinen Datenbankzugriff — Quelltext-Scan", async () => {
     ...
     * Werkzeug, das der Bestand dafuer haelt (`src/app/m/radio/riegel.test.ts:163-183`,
     ...
     *      bewusst stehen (`riegel.test.ts:157-161`: ein naiver Stripper koennte eine
