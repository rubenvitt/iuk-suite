 ...
 * in `src/app/m/radio/_lib/quelltextScan.ts:61-81`. Ein Import von dort zoege deren
...
describe("radio-Code: erzeugeCode", () => {
  ...
  it("nennt den eingebauten Pseudo-Zufall nicht — Quelltext-Scan", () => {
     ...
     *   laut, nie falsch-negativ und still (`_lib/quelltextScan.ts:57-63`).
     *
     ...
     * in `_lib/quelltextScan.ts:83-132`; der Schnitt hier kappt nur ab dem ersten Kommentarbeginn.
     *
     ...
     * Kommentarschnitte des Moduls (`_lib/quelltextScan.ts:209`, `_actions/guards.test.ts:294`,
