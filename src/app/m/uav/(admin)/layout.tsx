 ...
 *
 * `requireUavAdminPage()` steht HIER UND zusätzlich auf jeder einzelnen Seite
 * (Vorbild `radio/(ausleihe)/layout.tsx`s Kopfkommentar): eine Route-Group ist
 * Bequemlichkeit, keine Sicherheitsgrenze, und ein `page.test.tsx` rendert die
 * Seite ohnehin ohne dieses Layout.
 */
