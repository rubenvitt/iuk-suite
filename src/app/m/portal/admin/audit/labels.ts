...
export const OBJECT_LABELS: Record<string,string> = {
 ...
 artikel:"Artikel",buchungen:"Lagerbuchung",bz_geraete:"Betriebsstundengerät",bz_kontrollen:"Betriebsstundenkontrolle",chargen:"Charge",checks:"Fahrzeugkontrolle",fahrzeug_templates:"Fahrzeugvorlage",geraete:"Lagergerät",inventur_positionen:"Inventurposition",inventuren:"Inventurlauf",lagerort_verfall:"Verfall am Lagerort",lagerorte:"Lagerort",o2_flaschen:"Sauerstoffflasche",o2_messungen:"Sauerstoffmessung",soll_positionen:"Sollposition",template_positionen:"Vorlagenposition",tokens:"Helferzugang",
