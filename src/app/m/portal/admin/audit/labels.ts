...
export const OBJECT_LABELS: Record<string,string> = {
 ...
 artikel:"Artikel",buchungen:"Lagerbuchung",bz_geraete:"Betriebsstundengerät",bz_kontrollen:"Betriebsstundenkontrolle",bz_beachtung:"Beachtung am BZ-Gerät",chargen:"Charge",checks:"Fahrzeugkontrolle",fahrzeug_templates:"Fahrzeugvorlage",geraete:"Lagergerät",inventur_positionen:"Inventurposition",inventuren:"Inventurlauf",lagerort_verfall:"Verfall am Lagerort",lagerorte:"Lagerort",o2_flaschen:"Sauerstoffflasche",o2_messungen:"Sauerstoffmessung",soll_positionen:"Sollposition",template_positionen:"Vorlagenposition",tokens:"Helferzugang",
 ...
 sitzung_widerruf:"Sitzungswiderruf",
 session:"Anmeldung",sessions:"Sitzungen",idp_refresh:"Sitzung beim Identitätsanbieter",access:"Modulzugriff",access_throttled:"Weitere Ablehnungen nicht einzeln protokolliert",login_required:"Modulzugriff ohne Anmeldung",share_access:"Freigabezugriff",audit_log:"Audit-Log",browser_export:"Browserexport",bereich:"Bereich außerhalb des Kärtchens",
