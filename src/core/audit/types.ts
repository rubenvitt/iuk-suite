...
export type AuditFilters = { module?: AuditModule; action?: AuditAction; actorId?: string; objectRef?: string; result?: AuditResult; from?: number; to?: number; cursor?: AuditCursor; limit?: number };
