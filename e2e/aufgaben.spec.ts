...
/*
 * AB HIER AUFGABE 21 — DIE VERTAGTE TASTATURBEDIENUNG UND DIE VOLLEN DURCHLAEUFE. Der volle
 * Durchlauf steht ABSICHTLICH GANZ HINTEN (Begruendung an seinem eigenen Kopfkommentar) — seit
 * dem 2026-08-15 folgen ihm noch die ZWEI „leerer Start"-Faelle des Quellenwechsels, aus
 * derselben Ueberlegung und mit derselben Vorkehrung: auch ihre Kalenderdaten liegen ausserhalb
 * der aktuellen Woche. Der Tastatur-Fall VERAENDERT Bendix' Montag ein weiteres Mal und steht
 * deshalb nach den Zieh-Tests, nicht davor.
 *
 * ⚠️ DIE UMSCHALTUNG, DER WAAGERECHTE-SCROLL-CHECK, DIE FUEHRUNGSKARTE UND DER DUNKELMODUS
 * STEHEN SEIT DRK-408 IN `aufgaben-breiten.spec.ts` — sie sind les- und zustandsneutral fuer
 * die Woche, auf die Aufgabe 20s Zieh-Tests sich verlassen, und liessen sich deshalb als
 * einzige ohne Risiko abtrennen. Wer sie hier sucht und nicht findet, schliesst sonst
 * faelschlich, sie seien weggefallen.
 */
