 ...
 * `_lib/schreibpfade/codeEinloesung.ts:64`; die Zeile in `ausleihZugang.ts`, `befund` Schritt 5 bewacht den
 * LESEPFAD, und der ist Fall 4 (plus Fall 5, weil `requireAusleihSchreibend` denselben Rumpf
 * `befund` benutzt, `ausleihZugang.ts`, `requireAusleihSchreibend`). ⛔ FALL 3 IST DESHALB NICHT AUF DIE ANDERE ZEILE
