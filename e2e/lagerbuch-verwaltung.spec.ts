...
test.describe("lagerbuch — Modulnavigation", () => {
  ...
  test("neunzehn Einträge in der Leiste schieben die Seite nicht seitwärts — sie fängt ihren Überlauf senkrecht ab", async ({
    ...
    // 18 seit DRK-305 („Entnahme“, „Check durchführen“), 19 seit DRK-314
    // („Entnahmebox“). Die Zusage dieses Tests hängt NICHT an der Zahl,
    // sondern am Satz darunter: mehr Einträge machen die Marge größer, nicht
    // kleiner — deshalb ist ein neuer Eintrag hier eine Zahl im Diff und kein
    // Befund.
